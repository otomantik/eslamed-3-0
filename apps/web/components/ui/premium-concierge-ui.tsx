      ...
      <section className="py-12 -mt-8 relative z-10">
        <div className="container-wide">
          <div className="max-w-4xl mx-auto">
            <div className="relative overflow-hidden rounded-3xl bg-linear-to-br from-slate-900 to-slate-800 p-8 text-white shadow-2xl transform hover:scale-[1.01] transition-transform duration-300">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <a
                    href={`${getWhatsAppBaseUrl()}?text=VIP%20danışmanlık%20randevusu%20almak%20istiyorum`}
