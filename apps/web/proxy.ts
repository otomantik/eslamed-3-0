...
export const config = {
  matcher: [
     ...
     * - static files (public folder): images, fonts, PDFs, etc.
     */
    '/((?!api|_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp|ico|woff|woff2|ttf|eot|pdf|json|txt|xml)).*)',
  ],
};
